function [coords,elems,bonds,angles,dihedrals] = add_polymer(coords,elems,nch2,trans_mat,nlay1)
% nch2 = 2;
...
for ich2 = 1:nch2
   if mod(ich2,2)==1
       ...
       pol_coords = [pol_coords;ch2_trans*(ceil(ich2/2)-1)+ch2_1];
       
   else    
       
       pol_coords = [pol_coords;ch2_trans*(ceil(ich2/2)-1)+ch2_2];
...
coords([od1_id(1) od2_id(1)],:) = [];
elems([od1_id(1) od2_id(1)]) = [];
